...
# [GCC 7.3.0]
# Embedded file name: /home/john/Moocs/MITx6.00.2x V2 2019 2Q/ps3b_precompiled.py
...
def runDrugSimulation(numViruses, maxPop, maxBirthProb, clearProb, resistances, mutProb, numStepsBeforeDrugApplied, totalNumSteps):
    ...
    if not numStepsBeforeDrugApplied <= totalNumSteps:
...
# okay decompiling ps3b_precompiled_37.pyc
